...
public class tStuCurfewBizImpl implements tStuCurfewBiz{
    ...
    public List<tStuCurfew> findBySno(String Sno) {
        String sql = "select * from tStuCurfew where Sno = ? order by NightTime DESC" ;
	Object[] params = {Sno};
	return sdao.query(sql, tStuCurfew.class, params);
    }

    public List<tStuCurfew> findBySname(String Sname) {
        String sql = "select * from tStuCurfew where Sname = ? order by NightTime DESC";
	Object[] params = {Sname};
	return sdao.query(sql, tStuCurfew.class, params);
    }
        
    public List<tStuCurfew> findByDno(String Dno) {
        String sql = "select * from tStuCurfew where Dno = ? order by NightTime DESC";
	Object[] params = {Dno};
	return sdao.query(sql, tStuCurfew.class, params);
    }
    public List<tStuCurfew> findByPermit() {
        String sql = "select * from tStuCurfew where Tno is not null order by NightTime DESC";
	//Object[] params = {Tno};
	return sdao.query(sql, tStuCurfew.class);
    }

    public List<tStuCurfew> findByUnpermit() {
        String sql = "select * from tStuCurfew where Tno is null order by NightTime DESC";
	//Object[] params = {Tno};
	return sdao.query(sql, tStuCurfew.class);
    }
    public List<tStuCurfew> findByTno(String Tno) {
        String sql = "select * from tStuCurfew where Tno = ? order by NightTime DESC";
        Object[] params = {Tno};
        return sdao.query(sql, tStuCurfew.class, params);
    }
    ...
    public List<tStuCurfew> findAll() {
        String sql = "select * from tStuCurfew order by NightTime DESC";
	return sdao.query(sql, tStuCurfew.class);    
    }
